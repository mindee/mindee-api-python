...
## Customer Name
**customer_name** : The name of the customer or client.
...
## Document Type
**document_type** : One of: 'INVOICE', 'CREDIT NOTE'.
...
## Line Items
**line_items** ([InvoiceV4LineItem]List[(#line-items-field)]): List of line item details.
