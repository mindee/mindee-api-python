...
def invoice_v4_empty_doc() -> Document[GeneratedV1Document, Page[GeneratedV1Page]]:
    with open(
        V1_PRODUCT_PATH / "generated" / "response_v1" / "empty_invoice_v4.json",
        encoding="utf-8",
    ) as json_file:
        json_data = json.load(json_file)
    return Document(GeneratedV1, json_data["document"])
...
def invoice_v4_complete_doc() -> Document[GeneratedV1Document, Page[GeneratedV1Page]]:
    with open(
        V1_PRODUCT_PATH / "generated" / "response_v1" / "complete_invoice_v4.json",
        encoding="utf-8",
    ) as json_file:
        json_data = json.load(json_file)
    return Document(GeneratedV1, json_data["document"])
...
def test_invoice_v4_complete_doc(invoice_v4_complete_doc) -> None:
    with open(
        V1_PRODUCT_PATH / "generated" / "response_v1" / "summary_full_invoice_v4.rst",
        encoding="utf-8",
    ) as doc:
        doc_str = doc.read()
    assert isinstance(
...
def test_invoice_v4_page0(invoice_v4_page_0) -> None:
    with open(
        V1_PRODUCT_PATH / "generated" / "response_v1" / "summary_page0_invoice_v4.rst",
        encoding="utf-8",
    ) as doc:
        doc_str = doc.read()
...
def test_invoice_v4_empty_doc(invoice_v4_empty_doc) -> None:
    with open(
        V1_PRODUCT_PATH / "generated" / "response_v1" / "summary_empty_invoice_v4.rst",
        encoding="utf-8",
    ) as doc:
        doc_str = doc.read()
