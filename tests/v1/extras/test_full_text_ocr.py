...
from tests.utils import V1_EXTRAS_PATH


@pytest.fixture
def load_document():
    with open(V1_EXTRAS_PATH / "full_text_ocr/complete.json") as file:
...
def test_get_full_text_ocr_result(load_document):
    expected_text = (V1_EXTRAS_PATH / "full_text_ocr/full_text_ocr.txt").read_text()
