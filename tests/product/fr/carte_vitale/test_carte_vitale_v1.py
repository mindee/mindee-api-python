...
RESPONSE_DIR = PRODUCT_DATA_DIR / "carte_vitale" / "response_v1"

CarteVitaleV1DocumentType = Document[
    CarteVitaleV1Document,
    Page[CarteVitaleV1Document],
]


@pytest.fixture
def complete_doc() -> CarteVitaleV1DocumentType:
...
@pytest.fixture
def empty_doc() -> CarteVitaleV1DocumentType:
...
def test_complete_doc(complete_doc: CarteVitaleV1DocumentType):
...
def test_empty_doc(empty_doc: CarteVitaleV1DocumentType):
